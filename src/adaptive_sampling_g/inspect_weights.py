"""Inspect evolution of adaptive sampler weights and (optionally) confusion metrics.
    ...
    python src/adaptive_sampling_g/inspect_weights.py --dir results/adaptive_sampling_g/<RUN_TAG> --snr-trend --with-confusion

Examples:
    # All epochs, top 12 buckets, entropy metrics
    python src/adaptive_sampling_g/inspect_weights.py --dir results/adaptive_sampling_g/<RUN_TAG> --top 12 --entropy

    # Latest only with confusion summary (if confusion_epoch*.json present)
    python src/adaptive_sampling_g/inspect_weights.py --dir results/adaptive_sampling_g/<RUN_TAG> --latest --with-confusion

    # Concentration warnings customized
    python src/adaptive_sampling_g/inspect_weights.py --dir results/adaptive_sampling_g/<RUN_TAG> --warn-max-mult 6 --warn-entropy-ratio 0.50
...
def main():
    ...
    ap.add_argument('--dir', default='results/adaptive_sampling_g', help='Directory containing weights_epoch*.json files or a specific run directory')
