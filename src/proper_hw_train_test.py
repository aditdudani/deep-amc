...
# =============================================================================
# LOAD IMAGES - Use tf.data to stream from disk (avoid OOM)
# Matches train_squeezenet.py exactly
# =============================================================================
def make_dataset(data_dir, batch_size, shuffle=True):
    """Create tf.data dataset - EXACT copy from train_squeezenet.py"""
...
def main():
    ...
    # Load datasets using tf.data (streams from disk, avoids OOM)
